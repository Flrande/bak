...
3. [Memory Guide](./memory-guide.md): record/retrieve/replay repeated web tasks.
4. [Troubleshooting](./troubleshooting.md): diagnose pairing, RPC, and extension issues.
