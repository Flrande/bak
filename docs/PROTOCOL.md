...
- live sessions attach their tabs to the current browser window when one is active, and each session owns a dedicated tab group through an internal browser binding
